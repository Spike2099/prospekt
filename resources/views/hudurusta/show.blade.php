...
{{--                    <p class="label label-success">Склад Турция: {{$product['quantity']}}</p>--}}
                    ...
                    <div class="d-grid d-lg-flex align-items-center gap-4 w-100">
                        ...
                        @else
                            ...
                            @else
                                <div
                                        id="card<?=$product['id']?>"
                                        :data-card="['<?=$product['id']?>,<?=$product['article']?>,<?=$str?>,colyman,'+count+',<?=$product['price']?>,'+<?=$product['price']?>*count+',<?=$image;?>']"
