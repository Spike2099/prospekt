                ...
                <div>
                    <select id="selectOffset" class="form-select" onchange="selectOffset()">
                        @foreach ([12, 24, 48, 64, 100] as $key)
                            <option value="/originalParts/{{$key}}/0" @if($key == $limit) selected @endif >
                                {{$key}}
                            </option>
                        @endforeach
                    </select>                        
                ...
                <template v-else>
                    <div class="col-lg-3 col-12">
                        <div class="card card-data border-0 shadow-sm order">
                            ...
                            @endphp
                            <a href="/originalPartsProduct/{{$item['id']}}" class="card-body pb-0 position-relative">
                        ...
                        <div class="card-body">
                            ...
                            @include('nonoriginal.card.title')
            ...
            <div class="mt-5 d-flex align-items-center justify-content-between">
                <div>
                    <select id="selectOffsetBottom" class="form-select" onchange="selectOffsetBottom()">
                        @foreach ([12, 24, 48, 64, 100] as $key)
                            <option value="/originalParts/{{$key}}/0"
                        ...
                        @if ($offset != 0)
                            <li class="page-item p-0">
                                <a class="page-link text-primary border-0"
                                   href="/originalParts/{{$limit}}/{{$offset - $limit}}">
