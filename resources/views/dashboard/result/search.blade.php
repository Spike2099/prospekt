@php
    if(!isset($error)){
        ...
        $stockSize += ($stockPositionsArmTek ? count($stockPositionsArmTek) : 0);
...
@section('content')
    <section class="bg-secondary-subtle catalog">
        <div class="container position-relative py-4 py-lg-2">
            ...
            @endif
            @if(isset($error) || (($size + $stockSize == 0) && empty($analog)))
            ...
            @else
                ...
                $dongFeng || $colyman || $stockPositionsArmTek)
                    <p>
                        Товар со Склада
                    </p>
                    ...
                    <div class="row g-2">
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <p class="mb-0">
                                            <span class="badge rounded-pill {{ $item['quantity'] == 0 ? 'text-bg-danger' : 'text-bg-success' }} px-3" 
                                                ...
                                                data-bs-title="{{ $item['quantity'] == 0 ? 'Товара нет в наличии' : 'Доставка заказа осуществляется в течении 1-2 рабочих дней' }}">
                        ...
                        <div class="container">
                            @foreach($stockPositionsArmTek as $item)
                                @if(isset($item['article']))
                                    <div class="row border-bottom py-3 d-flex align-items-center">
                                        <!-- Image -->
                                        <div class="col-12 col-md-1 d-flex align-items-center">
                                 ...
                                 <p class="mb-0">
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <span class="badge rounded-pill text-bg-danger px-3"
                                              data-bs-toggle="tooltip"
                                              data-bs-title="Доставка заказа осуществляется в течение 1 или нескольих рабочих дней">
                                              В наличии
                                        </span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-1 d-flex align-items-center justify-content-end">
                                        <div>
                                            @if($item['quantity'] == 0)
                                                <div id="card{{$item['article']}}"
                                                     data-card="{{$item['article']}},{{$item['article']}},{{$item['name']}},{{$item['stock_category_id']}},1,{{$item['price']* 100}},{{$item['price']* 100}},{{$images::src($item['article'])}}"
                                                     v-on:click="colyman('{{$item['article']}}')"
                                                     class="btn btn-primary text d-flex align-items-center justify-content-center gap-2 py-2">
                                                    <x-icon-add-card size="25px" color="#fff"/>
                                                </div>
                                            @else
                                ...
                                @if(isset($item['article']))
                                    <div class="container">
                                        ...
                                        <div class="row border-bottom py-3 d-flex align-items-center">
                                            ...
                                            <div class="col-12 col-md-2">
                                                ...
                                                <p class="mb-0">
                                                    <a itemprop="name"
                                                       href="/dashboard/{{isset($item['link']) && $item['link'] === 'turkishProduct' ? 'turkishProduct' : 'product'}}/details/{{$item['id']}}"
                                                       class="text-decoration-none">
                                                        {{$item['link'] == 'dongfengProduct' ? 'DongFeng' : 'Mercedes-Benz'}}
                                                    </a>
                                                </p>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-1 d-flex align-items-center justify-content-end">
                                                <div>
                                                    @if($item['stock_category_id']  == 'colyman')
                                                        <div id="card{{$item['id']}}"
                                                             v-on:click="colyman('{{$item['id']}}')"
                                                             data-card="{{$item['id']}},{{$item['article']}},{{$item['name']}},{{$item['stock_category_id'] ?? 'colyman'}},1,{{$item['price']* 100}},{{$item['price']* 100}},{{$images::src($item['article'])}}"
                                                             class="btn btn-primary text d-flex align-items-center justify-content-center gap-2 py-2">
