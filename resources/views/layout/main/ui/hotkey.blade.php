        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <details open="">
                    ...
                    <p>Prospekt Parts — крупнейший дистрибьютор оригинальных автомобильных запасных частей, компонентов и расходных материалов</p>
                    <p>
                      Есть срочная доставка по Москве, отправляем в регионы. Безналичный расчет. Помощь в подборе. Консультация специалистов. Звоните!<br />
                        <em class="text-danger">Помощь в подборе. Консультация специалистов. Звоните!</em>    
                    </p>
                </details>
                <hr />
                <dl class="row">
